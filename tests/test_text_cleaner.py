...
def test_windows_line_endings():
    ...
    print("✓ Windows line endings normalized correctly")
...
def test_mac_line_endings():
    ...
    expected = "Line1\nLine2\nLine3"
    assert result == expected, f"Expected '{expected}', got '{result}'"
    print("✓ Mac line endings normalized correctly")
...
def test_tabs():
    ...
    expected = "Hello world here"
    assert result == expected, f"Expected '{expected}', got '{result}'"
    print("✓ Tabs normalized to single space")
...
def test_mixed_spaces_tabs():
    ...
    expected = "Hello world here"
    assert result == expected, f"Expected '{expected}', got '{result}'"
    print("✓ Mixed spaces and tabs normalized correctly")
...
def test_trailing_whitespace():
    ...
    expected = "Line1\nLine2\nLine3"
    assert result == expected, f"Expected '{expected}', got '{result}'"
    print("✓ Trailing whitespace removed from lines")
...
def test_leading_trailing_whitespace():
    ...
    expected = "Line1\nLine2"
    assert result == expected, f"Expected '{expected}', got '{result}'"
    print("✓ Leading and trailing whitespace removed")
...
def test_whitespace_only():
    ...
    expected = ""
    assert result == expected, f"Expected empty string, got '{result}'"
    print("✓ Whitespace-only string returns empty string")
...
def test_preserve_newlines():
    ...
    print("✓ Intentional newlines preserved")
...
def test_markdown_content():
    ...
    expected = "# Title\n\n## Section\n\nContent here"
    assert result == expected, f"Expected '{expected}', got '{result}'"
    print("✓ Markdown content cleaned correctly")
...
def test_single_line():
    ...
    expected = "Hello world"
    assert result == expected, f"Expected '{expected}', got '{result}'"
    print("✓ Single line cleaned correctly")
...
def test_mixed_line_endings():
    ...
    expected = "Line1\nLine2\nLine3\nLine4"
    assert result == expected, f"Expected '{expected}', got '{result}'"
    print("✓ Mixed line endings normalized correctly")
